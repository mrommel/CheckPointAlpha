//
//  solidLineCap.vert
//  @brief Vertex shader used to modify the geometry of the start and en cap based on the line radius(half of the line width).
//
...
attribute highp vec2    a_tangents;     //cap tangent
...
//flat
varying mediump float  v_lineCap;
...
void main()
{
    ...
    int pointEncode = int(abs(a_lineCoord));
    float u = 0.0;
