...
/** Called when the traffic information on the map has been automatically updated from the server.
 @param mapView The map view.
 */
- (void)mapViewDidFinishRefreshingTrafficInfo:(SKMapView*)mapView;

/** Called when a traffic incident was tapped. This methods returns information about the tapped traffic incident.
 @param mapView The map view.
 @param trafficIncident The traffic incident that was tapped.
 */
- (void)mapView:(SKMapView*)mapView didTapTrafficIncident:(SKTrafficIncident*)trafficIncident;
