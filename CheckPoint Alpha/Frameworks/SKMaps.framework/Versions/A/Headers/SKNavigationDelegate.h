...
/** Called when the traffic changed on the current route.
 @param routingService The routing service.
 @param updateData Stores update data about the traffic.
 */
- (void)routingService:(SKRoutingService*)routingService didUpdateTrafficWithData:(SKTrafficUpdateData*)updateData;

/** Called when a new FCD trip is started.
 @param routingService The routing service.
 @param tripId The id of the newly started trip.
 */
