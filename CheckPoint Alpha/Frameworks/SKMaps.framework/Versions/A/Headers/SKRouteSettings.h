...
/** Via Points along the route. An array of CLLocation objects.
 */
...
#pragma mark - Traffic
/** Indicates whether to use live traffic data for calculating best possible route.
 */
@property(nonatomic,assign) BOOL useLiveTraffic;
/** Indicates whether to use live traffic data for calculating the ETA.
 */
