...
/** The map style detail. Impacts rendering and performance. By default, is set to sKMapViewStyleDetailAuto.
 */
@property(nonatomic,assign) SKMapViewStyleDetail styleQuality;
