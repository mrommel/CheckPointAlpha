...
/** Controls the rendering of terrain elevation .
 */
@property(nonatomic,assign) BOOL terrainElevationEnabled;
/** Current traffic mode of the map, set by displayTrafficWithMode: method .
 */
@property(nonatomic,assign) SKTrafficMode trafficMode;
...
/** Controls if the Wiki travel POIs are displayed on the map.
 */
@property(nonatomic,assign) BOOL showWikiTravelPOIs;
