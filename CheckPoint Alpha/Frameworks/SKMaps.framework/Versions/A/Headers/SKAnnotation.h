...
/** Object containing an UIView which will represent the annotation image.
 */
@property(nonatomic,strong) SKAnnotationView *annotationView;

/** Optional text to be written below the annotation image.
 */
@property(nonatomic,strong) SKAnnotationText *annotationText;
