...
@optional
/** Called for a successfull address search operation.
 @param searchService The search service.
 @param searchResults Contains the result of an address search (a list of SKSearchResult objects).
 ...
 */
- (void)searchService:(SKSearchService *)searchService didRetrieveAddressSearchResults:(NSArray *)searchResults withSearchMode:(SKSearchMode)searchMode;

/** Called for a failed address search operation.
 @param searchService The search service.
 ...
 */
- (void)searchService:(SKSearchService *)searchService didFailToRetrieveAddressSearchResultsWithSearchMode:(SKSearchMode)searchMode;
...
/** Called for a successfull house number search operation.
 @param searchService The search service.
 @param searchResults Contains the house number search results (a list of SKSearchResult objects).
 */
- (void)searchService:(SKSearchService *)searchService didRetrieveHouseNumberSearchResults:(NSArray *)searchResults;

/** Called for a failed house number search operation.
 @param searchService The search service.
 */
- (void)searchServiceDidFailToRetrieveHouseNumberSearchResults:(SKSearchService *)searchService;
