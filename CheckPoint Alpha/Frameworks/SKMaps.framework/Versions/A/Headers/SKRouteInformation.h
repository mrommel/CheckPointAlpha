...
/** The delay caused by traffic of the calculated route, in seconds.
 */
@property(nonatomic,assign) int trafficDelay;

/** The traffic incidents on the route.
 */
@property(nonatomic,strong) NSArray* incidentsOnRoute;
@end
